<?php include("header.php");?>
 ...
 <div class="container-contact100">
    <div class="wrap-contact100">
      <form class="contact100-form validate-form" name="booking" method="post">
...
$con=mysqli_connect('localhost','root','','tent');
...
if (isset($_POST['submit'])) 
{
   ...
   echo $sql="INSERT INTO `booking`(`name`, `email`, `phone`,`service`, `message`) VALUES ('$name','$email','$phone','$service','$message');";
